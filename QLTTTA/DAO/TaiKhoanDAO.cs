...
namespace QLTTTA.DAO
{
   public class TaiKhoanDAO
   {
      ...
      public bool them(string mail, string matKhau, string quyenDangNhap)
      {
         try
         {
                SqlParameter[] sqlParams = { new SqlParameter("@Mail", SqlDbType.VarChar),
                new SqlParameter("@MatKhau", SqlDbType.VarChar),
                new SqlParameter("@QuyenDangNhap", SqlDbType.VarChar) };
            Object[] parameters = { mail, matKhau, quyenDangNhap};
            DataProvider.Instance.ExecuteNonQuery("ThemDangNhap", sqlParams, parameters);
            return true;
         }
         catch
         {
      ...
      public bool capNhat(string mail, string matKhau, string quyenDangNhap)
      {
         try
         {
            SqlParameter[] sqlParams = { new SqlParameter("@Mail", SqlDbType.VarChar),
                ...
                new SqlParameter("@QuyenDangNhap", SqlDbType.VarChar) };
            Object[] parameters = { mail, matKhau, quyenDangNhap };
            DataProvider.Instance.ExecuteNonQuery("CapNhatDangNhap", sqlParams, parameters);
            return true;
         }
         catch
         {
      ...
      public bool xoa(string mail)
      {
         try
         {
            ...
            DataProvider.Instance.ExecuteNonQuery("XoaDangNhap", sqlParams, parameters);
            return true;
         }
         catch
         {
